...
/// </summary>
public class LGRegulator {
	private LGTimer _timer = new LGTimer();
	...
	/// </param>
	public LGRegulator( float numUpdatesPerSecond ) {
...
/// </summary>
public class LGRangedRegulator : LGRegulator
{
	public LGRangedRegulator( float numUpdatesPerSecondMin, float numUpdatesPerSecondMax )
