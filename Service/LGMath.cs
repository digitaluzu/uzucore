...
public class LGMath
{
	...
	/// </summary>
	public static bool IntersectSegmentSphere(Vector3 p0, Vector3 p1, LGSphere s, out Vector3 hitPos)
	{
		Vector3 dir = p1 - p0;
	...
	/// </summary>
	public static bool IntersectRaySphere(Vector3 p, Vector3 d, LGSphere s, out float t, out Vector3 q)
	{
		// Ref: Real-Time Collision Detection
	...
	/// </summary>
	public static bool IntersectRaySphere(Vector3 p, Vector3 d, LGSphere s)
	{
		// Ref: Real-Time Collision Detection
